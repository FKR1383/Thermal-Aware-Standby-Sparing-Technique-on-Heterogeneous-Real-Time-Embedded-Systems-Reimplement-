...
from common.cores.arm.ex5_LITTLE import ex5_LITTLE, L1I, L1D, L2  # فرض کن این فایل اسمش ex5_little_core.py باشه
...
# CPU
system.cpu = ex5_LITTLE(cpu_id=0)
...
print("Starting simulation with ex5_LITTLE core (Cortex-A7-like)")
